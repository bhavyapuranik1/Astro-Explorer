...
canvas.node().style.height =
  ...
  function getAtmosphereColors(sunAlt, moonAlt, moonIllum, bortle) {
    ...
    if (moonBright > 0 && typeof moonAlt !== "undefined" && moonAlt > 0) {
      var moonIllumVal = (typeof moonIllum !== "undefined" && moonIllum > 0) ? moonIllum : 0.5;
      var moonFactor = Math.sin(moonAlt * Math.PI / 180) * moonIllumVal * moonBright;

      if (moonFactor > 0.01) {
        zenithColor = d3.interpolateRgb(zenithColor, "#0e182b")(moonFactor * 0.45);
        midSkyColor = d3.interpolateRgb(midSkyColor, "#122036")(moonFactor * 0.55);
        horizonColor = d3.interpolateRgb(horizonColor, "#1a2c47")(moonFactor * 0.65);
      }
    }
  ...
  function drawOutline(stroke) {
    ...
    if (stroke === true) {
      ...
      if (typeof sunAltitude !== "undefined" && typeof lightPollution !== "undefined" && (typeof skySettings === "undefined" || skySettings.horizonGlow !== false)) {
        ...
        // Draw Moon glare (if moon is above horizon and illuminated)
        if (moonAltitude > 0 && typeof moonPosition !== "undefined" && typeof moonIllumination !== "undefined" && moonIllumination > 0.1) {
          try {
            mapProjection.rotate(rot);
            const moonPt = mapProjection(moonPosition);
            mapProjection.rotate([0, 0]);
            if (isVal(moonPt)) {
              const radius = Math.max(40, 120 * moonIllumination);
              ...
              glare.addColorStop(0.2, "rgba(230, 240, 255, 0.55)");
              glare.addColorStop(0.5, "rgba(200, 220, 255, 0.2)");
