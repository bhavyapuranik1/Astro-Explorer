...
canvas.node().style.height =
  ...
  function getAtmosphereColors(sunAlt, moonAlt, moonIllum, bortle) {
    ...
    var skyBright = (typeof skySettings !== "undefined" && skySettings.skyBrightness !== undefined) ? skySettings.skyBrightness : 1;
    if (skyBright < 1.0) {
      zenithColor = d3.interpolateRgb(nightZenith, zenithColor)(skyBright);
      midSkyColor = d3.interpolateRgb(nightMid, midSkyColor)(skyBright);
      horizonColor = d3.interpolateRgb(nightHorizon, horizonColor)(skyBright);
    }
  ...
  function actualRedraw() {  
    ...
    if (typeof sunAltitude !== "undefined" && (typeof skySettings === "undefined" || skySettings.horizonGlow !== false)) {
      if (sunAltitude >= -6) {
        overlayDimmer = 0.0;
  ...
  function drawOutline(stroke) {
    ...
    if (stroke === true) {
      ...
      // ── Atmosphere / Twilight Gradient ──
      let hasAtmosphere = false;
      if (typeof sunAltitude !== "undefined" && typeof lightPollution !== "undefined" && (typeof skySettings === "undefined" || skySettings.horizonGlow !== false)) {
        hasAtmosphere = true;
        context.save();
