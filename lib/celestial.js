    ...
    if (cfg.stars.show) { 
      ...
      selectCached(parentElement + " .star").each(function(d) {
        ...
        if (clip(coords) && effectiveMag <= skyLimit && alt > 0) {
          ...
          // Star Opacity: Star Magnitude slider directly controls star limit,
          // Bortle scale applies realistic city sky glow dimming to faint stars without blocking them
