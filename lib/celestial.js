...
Celestial.display = function(config) {
  ...
  console.log("projectionSetting object");
console.dir(projectionSetting);
...
console.log("cfg.height =", cfg.height);
console.log("parent =", parent);
console.log("parent.clientHeight =", parent ? parent.clientHeight : "NO PARENT");
...
canvasheight = Math.round(height);
    ...
    console.log("Projection ratio =", projectionSetting.ratio);
console.log("Translate =", mapProjection.translate());
console.log("Scale =", mapProjection.scale());
    redraw();
}
...
canvas.node().style.height =
    canvasheight + "px";
      ...
      mapProjection.precision(0.1);
      console.log("INITIAL ratio =", projectionSetting.ratio);
console.log("INITIAL translate =", mapProjection.translate());
console.log("INITIAL scale =", mapProjection.scale());
      map.projection(mapProjection);
      setClip(false); 
