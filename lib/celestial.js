  ...
  function actualRedraw() {  
    ...
    if (cfg.mw.show) { 
      ...
      if (finalMwBright > 0.05) {
          ...
          // Quantize rotation precision during smooth panning/rotation to maximize texture reuse
          var rotStep = (window.isPanningSky || window.isRotatingSky) ? 0.4 : 0.05;
          ...
          var cacheKey = qRot0 + "_" + qRot1 + "_" + qRot2 + "_" + curScale.toFixed(1) + "_" + finalMwBright.toFixed(2) + "_" + overlayDimmer.toFixed(2);
          var mwCache = window._mwCache;
          var mainCanvas = context.canvas;

          if (!mwCache.valid || mwCache.key !== cacheKey || mwCache.canvas.width !== mainCanvas.width || mwCache.canvas.height !== mainCanvas.height) {
            mwCache.canvas.width = mainCanvas.width;
            mwCache.canvas.height = mainCanvas.height;
            ...
            // Group features by layer to batch draw calls and reduce canvas state changes
            ...
            ['ol1', 'ol2', 'ol3', 'ol4', 'ol5'].forEach(function(layerId) {
              ...
              offCtx.shadowBlur = st.shadowBlur;
          ...
          // Blit cached texture directly to main context
          context.save();
          context.setTransform(1, 0, 0, 1, 0, 0);
          context.drawImage(mwCache.canvas, 0, 0);
          context.restore();
      }
    }
