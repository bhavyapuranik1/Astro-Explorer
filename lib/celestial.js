...
canvas.node().style.height =
  ...
  function starSize(d) {
    ...
    // We heavily shrink faint stars to be crisp points (< 1px) and only let bright stars get larger
    var r = starbase * adapt * Math.pow(2.512, (starexp * (mag + 2))) * 0.45;
    ...
    // Let faint stars be tiny, down to 0.2 pixels
