...
canvas.node().style.height =
  ...
  // ── ATMOSPHERE / TWILIGHT MODEL ──
  function getAtmosphereColors(sunAlt, moonAlt, moonIllum, bortle) {
    var zenithColor = "#000000";
    var midSkyColor = "#000000";
    var horizonColor = "#000000";
    ...
    var nightColor = baseNightColors[Math.min(8, Math.max(0, Math.round(bortle) - 1))];
    ...
    if (sunAlt > 12) {
      ...
      var t = sunAlt / 12;
      zenithColor = d3.interpolateRgb("#090a14", "#051125")(t);
      midSkyColor = d3.interpolateRgb("#3e1f52", "#112e5a")(t);
      horizonColor = d3.interpolateRgb("#d35400", "#4481c4")(t);
    } else if (sunAlt > -6) {
      var t = (sunAlt - (-6)) / 6;
      zenithColor = d3.interpolateRgb("#04050c", "#090a14")(t);
      midSkyColor = d3.interpolateRgb("#150b28", "#3e1f52")(t);
      horizonColor = d3.interpolateRgb("#6d1111", "#d35400")(t);
    } else if (sunAlt > -12) {
      var t = (sunAlt - (-12)) / 6;
      zenithColor = d3.interpolateRgb(nightColor, "#04050c")(t);
      midSkyColor = d3.interpolateRgb(nightColor, "#150b28")(t);
      horizonColor = d3.interpolateRgb(nightColor, "#32114d")(t);
    } else if (sunAlt > -18) {
      var t = (sunAlt - (-18)) / 6;
      zenithColor = nightColor;
      midSkyColor = nightColor;
      horizonColor = d3.interpolateRgb(nightColor, "#0d1530")(t);
    } else {
      zenithColor = nightColor;
      midSkyColor = nightColor;
      horizonColor = nightColor;
    }

    // Scale sky brightness based on user setting
    var skyBright = (typeof skySettings !== "undefined" && skySettings.skyBrightness !== undefined) ? skySettings.skyBrightness : 1;
    if (skyBright < 1.0) {
      zenithColor = d3.interpolateRgb(nightColor, zenithColor)(skyBright);
      midSkyColor = d3.interpolateRgb(nightColor, midSkyColor)(skyBright);
      horizonColor = d3.interpolateRgb(nightColor, horizonColor)(skyBright);
    }
    
    // Moonlight influence adds a gray-blue haze
    ...
    if (moonBright > 0) {
      var moonAltVal = (typeof moonAlt !== "undefined" && moonAlt > 0) ? moonAlt : 45;
      var moonIllumVal = (typeof moonIllum !== "undefined" && moonIllum > 0) ? moonIllum : 0.75;
      var moonFactor = (moonAltVal / 90) * moonIllumVal * moonBright;
      zenithColor = d3.interpolateRgb(zenithColor, "#101625")(moonFactor * 0.4);
      midSkyColor = d3.interpolateRgb(midSkyColor, "#121b2d")(moonFactor * 0.5);
      horizonColor = d3.interpolateRgb(horizonColor, "#1c2c45")(moonFactor * 0.6);
    }
    
    return { zenithColor: zenithColor, midSkyColor: midSkyColor, horizonColor: horizonColor };
  }
  ...
  function actualRedraw() {  
    ...
    if (cfg.stars.show) { 
      ...
      var latRad = 23 * Math.PI / 180;
      var lstRad = 77 * Math.PI / 180;
      if (typeof observer !== "undefined") {
        latRad = observer.latitude * Math.PI / 180;
      ...
      selectCached(parentElement + " .star").each(function(d) {
        ...
        if (clip(coords) && effectiveMag <= skyLimit && alt > 0) {
          ...
          if (d.properties.mag < 1.5) {
             ...
             context.shadowBlur = 4 + (1.5 - d.properties.mag) * 2;
